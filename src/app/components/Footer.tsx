    ...
    <footer className="bg-background py-12 border-t border-secondary/20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Nithin Ram Kalava</h3>
            <p className="mb-4 text-secondary">
              Full Stack Developer specializing in web application development, data analytics, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/skills" className="text-secondary hover:text-primary transition-colors">Skills</Link>
              </li>
              <li>
                <Link href="/projects" className="text-secondary hover:text-primary transition-colors">Projects</Link>
              </li>
              <li>
                <Link href="/certifications" className="text-secondary hover:text-primary transition-colors">Certifications</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <Link href="/contact" className="btn inline-block mt-2">
              Get in Touch
            </Link>
          </div>
        </div>
